function FvCB=Func_Leaf_FvCB_Photosynthesis_Model(V25, J25, Rd25, T, Topt, I, Ci, Pres, PSII_in, Phi_in)
...
LPT=Func_Leaf_Physiology_Temperature_Response(V25, J25, Rd25, T, Topt, Pres);
